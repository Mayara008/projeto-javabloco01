	...
	public void Apresentar() {
		...
		delay(40);
           ...
           /*if (num3==2) {
				...
				System.out.println("Muito obrigado! Esperamos que retorne em breve caso mude de idÃ©ia :D ");
				
			}
			
			if (num3==1) {
				
				System.out.println("Deseja se tornar um apoiador de uma ONG? Por favor, selecione 1 => SIM || 2 => NÃƒO ");
			num5=ler.nextInt();
			}*/
